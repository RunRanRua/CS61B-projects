...
public class UnionFindTest {
    ...
    public void initialStateTest() {
        ...
        assertThat(uf.isConnected(0, 1)).isFalse();
        assertThat(uf.isConnected(0, 2)).isFalse();
        assertThat(uf.isConnected(0, 3)).isFalse();
        assertThat(uf.isConnected(1, 2)).isFalse();
        assertThat(uf.isConnected(1, 3)).isFalse();
        assertThat(uf.isConnected(2, 3)).isFalse();
    }
